...
class Chatbot:
    ...
    qa_template = """You are a friendly conversational assistant, designed to answer questions and chat with the user from a knowledge base about 王勉.
        You receive data from a user's file and a question, you must help the user find the information they need. 
        Your answers must be user-friendly and respond to the user in Chinese.
        question: {question}
        =========
        context: {context}
        ======="""
